...
{
    template<class... Args> explicit json(Args ... args) : jsonResult(args ...) {}
...
private:
    ...
    bool str_view_4_1(state_t & state);
    void _str_view_4_1(const char * data, unsigned len, uint64_t consumed);
    ...
    bool str_view_6_1(state_t & state);
    void _str_view_6_1(const char * data, unsigned len, uint64_t consumed);
    bool text_6_2(state_t & state);
    bool notify_6_3(state_t & state);
    bool str_view_7_0(state_t & state);
    void _str_view_7_0(const char * data, unsigned len, uint64_t consumed);
    ...
    bool str_view_11_0(state_t & state);
    void _str_view_11_0(const char * data, unsigned len, uint64_t consumed);
