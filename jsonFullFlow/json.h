...
private:
    ...
    bool func2_1();
    bool func3_1();
    void string4_1(const char * data, size_t len, size_t consumed);
    void string6_1(const char * data, size_t len, size_t consumed);
    void string7_0(const char * data, size_t len, size_t consumed);
    bool func8_1();
    bool func9_1();
    bool func10_1();
    bool func11_0();
    void string12_0(const char * data, size_t len, size_t consumed);
